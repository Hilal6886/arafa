            ...
            <div className="mx-6 py-10 text-center md:text-left">
                <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="">
                        <Link
                            to="/"
                            className="mb-4 lg:mt-[-2rem] flex items-center justify-center font-semibold uppercase md:justify-start"
                        >
                            <img src={logo2} className="h-[4rem]" alt="Arafa Logo" />
                        </Link>
                    ...
                    <div>
                        ...
                        <p className="mb-4 flex  text-gray-400 text-lg items-center justify-center md:justify-start">
                            ...
                            #410, 5th main, 3rd Block, H.B.R Layout, Bangalore 560043
                        </p>
                        <p className="mb-4 flex  text-gray-400 text-lg items-center justify-center md:justify-start">
                            <svg
